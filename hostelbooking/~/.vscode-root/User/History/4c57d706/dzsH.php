...
ini_set('display_errors', 1);
  ...
  require('admin/inc/fpdf/vendor/autoload.php');
  ...
  if(isset($_GET['gen_pdf']) && isset($_GET['id']))
  {
    ...
    <table border='1'>
      ...
      <tr>
        ...
        <td>Cost: KES $data[price] per semister</td>
      </tr>
      <tr>
    ...
    if($data['booking_status']=='cancelled')
    {
      ...
      $table_data.="<tr>
        <td>Amount Paid: KES $data[trans_amt]</td>
        <td>Refund: $refund</td>
      </tr>";
    }
    ...
    {
      $table_data.="<tr>
        <td>Transaction Amount: KES $data[trans_amt]</td>
