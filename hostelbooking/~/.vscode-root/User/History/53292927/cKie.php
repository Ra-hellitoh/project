...
$fetch_booking_query = "SELECT id, check_out FROM booking_order WHERE room_number = ? AND booking_status = 'booked' ORDER BY id DESC LIMIT 1";
...
$checkout_date = $booking['check_out'] ?: date("Y-m-d H:i:s", strtotime("+1 day")); // Default checkout to next day if not set
