...
while ($data = mysqli_fetch_assoc($result)) {
    ...
    $checkin = !empty($data['check_in']) ? date("d-m-Y", strtotime($data['check_in'])) : 'Not provided';
    $checkout = !empty($data['check_out']) ? date("d-m-Y", strtotime($data['check_out'])) : 'Not provided';
    ...
    if ($data['booking_status'] == 'booked') {
        ...
        if (!empty($data['check_in'])) {
            // User has checked in, show the print receipt button only
            $btn = "<a href='generate_pdf.php?gen_pdf&id=$data[booking_id]' class='btn btn-dark btn-sm shadow-none mb-10'>Download PDF</a>";
            ...
            // User has not checked in, show Check-In button
            $btn = "<a href='confirm_booking.php?id=$data[room_id]' class='btn btn-success btn-sm shadow-none'>Check In</a>";
        }
    ...
    echo <<<bookings
        <div class='col-md-4 px-4 mb-4'>
          <div class='bg-white p-3 rounded shadow-sm'>
            ...
            <p>KES $data[price] per semister</p>
            <p>
              <b>Check in: </b> $checkin <br>
            </p>
            <p>
              <b>Amount: </b> KES $data[price] <br>
