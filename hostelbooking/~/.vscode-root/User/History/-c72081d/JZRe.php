        ...
        <?php 
          ...
          else
          {
            echo<<<data
              ...
              <a href="/rael/hostelbooking/admin/" class="btn btn-warning shadow-none" target="blank">Admin Login</a>
            data;
          }
        ?>
      </div>
    ...
    <div class="modal-body">
        <form action="add_student.php" method="POST" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <input type="password" name="confirm_password" id="confirm_password" class="form-control" minlength="4" required>
            </div>
