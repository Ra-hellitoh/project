<?php 
  ...
  if(isset($_POST['add_room']))
  {
    ...
    $q1 = "INSERT INTO `rooms` (`name`, `area`, `price`, `quantity`, `beds`, `chair`, `description`) VALUES (?,?,?,?,?,?,?)";
    $values = [$frm_data['name'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['beds'],$frm_data['chair'],$frm_data['desc']];
  ...
  if(isset($_POST['edit_room']))
  {
    ...
    $q1 = "UPDATE `rooms` SET `name`=?,`area`=?,`price`=?,`quantity`=?,
      `beds`=?,`chair`=?,`description`=? WHERE `id`=?";
    $values = [$frm_data['name'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['beds'],$frm_data['chair'],$frm_data['desc'],$frm_data['room_id']];
