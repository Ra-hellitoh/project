...
**Library - Chore**
- [PR #1090](https://github.com/sendgrid/sendgrid-php/pull/1090): drop support for EOL PHP versions and add support for PHP 8. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)! **(breaking change)**
...
--------------------------
**Library - Fix**
- [PR #1006](https://github.com/sendgrid/sendgrid-php/pull/1006): don't wrap names in double-quotes. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!
...
--------------------------
**Library - Fix**
- [PR #1001](https://github.com/sendgrid/sendgrid-php/pull/1001): support 'to' addresses with subjects. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!
...
**Library - Feature**
- [PR #969](https://github.com/sendgrid/sendgrid-php/pull/969): verify signature from event webhook. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!


[2020-05-27] Version 7.5.2
--------------------------
**Library - Fix**
- [PR #966](https://github.com/sendgrid/sendgrid-php/pull/966): Rename 'BaseInterface' to 'BaseSendGridClientInterface.php'. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!
...
--------------------------
**Library - Fix**
- [PR #960](https://github.com/sendgrid/sendgrid-php/pull/960): migrate to common prism setup. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!


[2020-04-29] Version 7.5.0
--------------------------
**Library - Fix**
- [PR #952](https://github.com/sendgrid/sendgrid-php/pull/952): refactor and fix personalization inserts/updates. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!

**Library - Feature**
- [PR #951](https://github.com/sendgrid/sendgrid-php/pull/951): add support for Twilio Email. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!
...
--------------------------
**Library - Chore**
- [PR #941](https://github.com/sendgrid/sendgrid-php/pull/941): add PHP 7.4 to Travis and test with lowest dependencies. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!
...
- [PR #939](https://github.com/sendgrid/sendgrid-php/pull/939): drop the prism binary and ignore unneeded files from the archive. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!


[2020-01-22] Version 7.4.2
--------------------------
**Library - Docs**
- [PR #928](https://github.com/sendgrid/sendgrid-php/pull/928): baseline all the templated markdown docs. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!
...
**Library - Chore**
- [PR #926](https://github.com/sendgrid/sendgrid-php/pull/926): prep the repo for automated releasing. Thanks to [@chairish-sambino](https://github.com/chairish-sambino)!
