  ...
  if(isset($_GET['fetch_rooms']))
  {
    ...
    while($room_data = mysqli_fetch_assoc($room_res))
    {
      ...
      if(!$settings_r['shutdown']){
        ...
        $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id],\"{$chk_avail['checkin']}\",\"{$chk_avail['checkout']}\")' class='btn btn-sm w-100 text-white custom-bg shadow-none mb-2'>Book Now</button>";
      }
