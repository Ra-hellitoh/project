...
ini_set('display_errors', 1);
  ...
  if (isset($_POST['register'])) {
      ...
      // Validate and set `dob` to NULL if it's an empty string or an invalid date
      ...
      $img = !empty($_FILES['profile']['name']) ? uploadUserImage($_FILES['profile']) : NULL;
      ...
      $query = "INSERT INTO `user_cred`(`name`, `email`, `address`, `phonenum`, `pincode`, `dob`, 
          `profile`, `password`, `token`, `gender`, `is_verified`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
