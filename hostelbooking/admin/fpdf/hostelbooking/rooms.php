...
<body class="bg-light">
  ...
  <?php 
    ...
    if(isset($_GET['check_availability']))
    {
      ...
      $beds_default = $frm_data['beds'];
      $chairs_default = $frm_data['chairs'];
    }
  ?>
              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <div class="d-flex">
                  <div class="me-3">
                    ...
                    <input type="number" min="1" id="beds" value="<?php echo $beds_default ?>" oninput="guests_filter()" class="form-control shadow-none">                 
                  </div>
                  <div>
                    <label class="form-label">Chairs</label>
                    <input type="number" min="1" id="chairs" value="<?php echo $chairs_default ?>" oninput="guests_filter()" class="form-control shadow-none">                 
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    function guests_filter(){
      if(tables.value>0 || chairs.value>0){
        fetch_rooms();
