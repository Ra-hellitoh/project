...
- CSS support for :nth-chair() selector improved to fully support the draft CSS3 spec - http://www.w3.org/TR/selectors/#nth-chair-pseudo
...
- underline and strikethrough now use the parent inline block baseline/fontsize/color for chair inline elements *** change in behaviour
